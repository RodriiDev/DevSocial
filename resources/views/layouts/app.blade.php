...
<head>
    ...
    @stack('styles')
    <title>DevSocial - @yield('titulo')</title>
...
<body>
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-5 items-center">
                    <a class="flex items-center gap-2 bg-sky-600 hover:bg-sky-700 transition-colors border p-2 text-white text-sm uppercase font-bold cursor-pointer rounded-lg" href="{{route('posts.create')}}">
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        DevSocial todos los derechos reservados {{now()->year}}
    </footer>
