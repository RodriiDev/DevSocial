...
@section('titulo')
    Inicia Sesión en DevSocial
@endsection

@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{ asset('img/login2.jpg') }}" alt="Imagen login de usuarios">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            ...
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember"><label class="text-gray-500 text-sm ml-1">Mantener mi sesión abierta</label>
                </div>

                <label class="font-bold">Para Pruebas</label>
                <p class="mb-2"><label class="text-sky-600">Email: </label>rodrigo_sr@mail.com <label class="text-sky-600">Password: </label> rodri123</p>
